        ...
        <Reveal direction="scale" duration={0.7} className="relative overflow-hidden rounded-[28px] bg-[color:var(--color-brand-400)] px-8 py-12 sm:px-14 sm:py-14 lg:px-20">
          <div className="relative grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div className="flex flex-col gap-6 text-center lg:text-left">
              ...
              <Reveal delay={0.35} className="flex items-center justify-center gap-5 lg:justify-start">
            ...
            <Reveal direction="left" delay={0.2} duration={0.7} className="relative mx-auto flex h-[360px] w-full max-w-sm items-center justify-center">
